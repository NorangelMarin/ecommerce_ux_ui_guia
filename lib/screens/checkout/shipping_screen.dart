            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 12),
                  Text(
                    'Completa los datos para coordinar el envío de tus productos Unimet.',
                  ...
                  Padding(
                    ...
                    child: CustomButton(
                      text: _isSaving ? 'Guardando...' : 'Ir a método de pago',
                              ...
                              if (currentSelection == 'nueva') {
                                ...
                                if (_saveAddress &&
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Por favor ingresa un alias para guardar la dirección',
                                      ),
                                      backgroundColor: Colors.red,
                                    ),
                                  );
