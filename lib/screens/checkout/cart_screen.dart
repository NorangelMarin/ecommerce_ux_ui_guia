            ...
            child: cartItems.isEmpty
                ? Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.shopping_cart_outlined, size: 64, color: AppColors.sombras),
                        SizedBox(height: 16),
                        Text(
                          'Tu carrito está vacío',
                          style: theme.textTheme.bodyLarge?.copyWith(color: AppColors.sombras),
                        ),
                      ],
                    ),
                  )
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text('Subtotal:', style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.bold, color: AppColors.textoPrincipal)),
                      Text('\$ ${subtotal.toStringAsFixed(2)}', style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.bold, color: AppColors.verdeSaman)),
                    ],
                  ),
                  SizedBox(height: 12),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Descuentos:', style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.bold, color: AppColors.textoPrincipal)),
                      Text('-\$ ${discount.toStringAsFixed(2)}', style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.bold, color: AppColors.naranjaUnimet)),
                    ],
                  ),
                  SizedBox(height: 16),
                  Divider(color: AppColors.verdeSaman, thickness: 1.5),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Total:', style: theme.textTheme.displayMedium?.copyWith(fontWeight: FontWeight.bold, fontSize: 18, color: AppColors.textoPrincipal)),
                      Text('\$ ${total.toStringAsFixed(2)}', style: theme.textTheme.displayMedium?.copyWith(fontWeight: FontWeight.bold, fontSize: 16, color: AppColors.verdeSaman)),
                    ],
                  ),
                        ...
                        if (phone == null || phone.trim().isEmpty) {
                          showDialog(
                            ...
                            builder: (ctx) => AlertDialog(
                              title: Text('Teléfono requerido', style: TextStyle(fontWeight: FontWeight.bold)),
