      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            Text(
              'Encuentra soluciones rápidas para tus pedidos o contacta directamente con nuestro equipo de soporte especializado.',
            ...
            GuideWrapper(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 12),
                  Text(
                    'Realiza cambios inmediatos en tus compras recientes.',
                    style: theme.textTheme.bodyMedium?.copyWith(
                      color: AppColors.sombras,
                      fontSize: 12,
                      height: 1.4,
            ...
            GuideWrapper(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  SizedBox(height: 12),
                  Text(
                    'Consulta nuestra sección de preguntas frecuentes y encuentra soluciones rápidas a problemas comunes.',
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(Icons.help_outline, color: AppColors.azulSistemas, size: 18),
                          SizedBox(width: 8),
                          Text(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isExpanded
                ? AppColors.azulSistemas.withValues(alpha: 0.6)
            ...
            Row(
              ...
              children: [
                ...
                AnimatedRotation(
                  ...
                  duration: Duration(milliseconds: 250),
                  child: Icon(Icons.keyboard_arrow_down, color: AppColors.naranjaUnimet, size: 22),
                ),
              ],
            ),
            if (isExpanded) ...[
              ...
              if (policy['note'] != null) ...[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: AppColors.azulSistemas.withValues(alpha: 0.07),
                    borderRadius: BorderRadius.circular(8),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Icon(Icons.info_outline, color: AppColors.azulSistemas, size: 16),
                      SizedBox(width: 8),
                      Expanded(
                        child: Text(
                          policy['note']!,
