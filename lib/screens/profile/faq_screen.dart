          ...
          Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                border: Border.all(color: AppColors.sombras.withValues(alpha: 0.15)),
              ),
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.search, color: AppColors.sombras, size: 20),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 12),
          Text(
            'Nuestro equipo de soporte está disponible de lunes a viernes para ayudarte con lo que necesites.',
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.chat_bubble_outline, color: AppColors.azulSistemas, size: 18),
                  SizedBox(width: 8),
                  Text(
