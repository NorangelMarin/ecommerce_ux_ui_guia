      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            backgroundColor: AppColors.verdeSaman,
          ),
        );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          Text(
            'Han confirmado la recepción del pedido',
            textAlign: TextAlign.center,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _buildRatingButton(
                ...
                iconColor: AppColors.azulSistemas,
                disabled: hasSubmitted,
              ),
              _buildRatingButton(
                index: 2,
          ...
          GuideWrapper(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: hasSubmitted ? AppColors.sombras.withValues(alpha: 0.05) : AppColors.blanco,
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: theme.textTheme.bodyMedium?.copyWith(
                    color: AppColors.sombras.withValues(alpha: 0.5),
                    fontSize: 12,
                  ),
      ...
      child: Column(
        children: [
          AnimatedContainer(
            ...
            height: 56,
            decoration: BoxDecoration(
              color: isSelected ? AppColors.naranjaUnimet.withValues(alpha: 0.1) : AppColors.blanco,
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
                color: isSelected ? AppColors.naranjaUnimet : AppColors.sombras.withValues(alpha: 0.1),
              ),
            ),
            child: Icon(
              icon,
              color: disabled && !isSelected ? AppColors.sombras.withValues(alpha: 0.3) : iconColor,
              size: 32,
            ),
          ),
          SizedBox(height: 8),
          Text(
            ...
            style: theme.textTheme.bodyMedium?.copyWith(
              ...
              color: isSelected ? AppColors.naranjaUnimet : AppColors.sombras,
            ),
          ),
        ],
      ),
