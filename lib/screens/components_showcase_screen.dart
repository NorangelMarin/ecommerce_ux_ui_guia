    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text('tarjetas_cards'.tr(), style: theme.textTheme.displayMedium),
            SizedBox(height: 16),
            Row(
            ...
            Text('progreso_stepper'.tr(), style: theme.textTheme.displayMedium),
            CheckoutStepper(currentStep: 2),
            SizedBox(height: 32),

            Text('modales__alertas'.tr(), style: theme.textTheme.displayMedium),
            SizedBox(height: 16),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                ElevatedButton(
                  ...
                  child: Text('xito'.tr(), style: TextStyle(color: Colors.white)),
                ),
                ElevatedButton(
                  onPressed: () => _showAlert(context, AlertType.advertencia, 'Revisa los datos ingresados.'),
                  style: ElevatedButton.styleFrom(backgroundColor: Colors.orange),
                  child: Text('aviso'.tr(), style: TextStyle(color: Colors.white)),
                ),
                ElevatedButton(
                  onPressed: () => _showAlert(context, AlertType.error, 'Hubo un error al procesar.'),
                  style: ElevatedButton.styleFrom(backgroundColor: Colors.red),
                  child: Text('error'.tr(), style: TextStyle(color: Colors.white)),
                ),
              ],
            ),
            SizedBox(height: 32),

            Text('botones'.tr(), style: theme.textTheme.displayMedium),
            SizedBox(height: 16),
            ...
            Text('campos_de_texto'.tr(), style: theme.textTheme.displayMedium),
            SizedBox(height: 16),
