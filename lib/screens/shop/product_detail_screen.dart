...
class ProductDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (productsAsync.isLoading) {
      return Scaffold(
        body: Center(
          child: CircularProgressIndicator(color: AppColors.naranjaUnimet),
        ),
      );
    }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (product.specs.isNotEmpty) ...[
                      ...
                      _buildSpecRow('Categoría principal', product.category),
                    ...
                    children: [
                      ...
                      if (hasPurchased && !hasReviewed)
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: AppColors.verdeSaman.withValues(alpha: 0.12),
                            borderRadius: BorderRadius.circular(8),
                          ),
                          child: Row(
                            children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: List.generate(5, (i) {
                                    if (i < product.ratingPromedio.floor()) {
                                      ...
                                      return Icon(
                                        Icons.star_border,
                                        color: AppColors.sombras.withValues(
                                          alpha: 0.4,
                                        ),
                                        size: 18,
                                      );
                                ...
                                SizedBox(height: 4),
                                Text(
                                  'Basado en ${product.totalResenas} reseña${product.totalResenas == 1 ? '' : 's'}',
                                  style: theme.textTheme.bodySmall?.copyWith(
                                    color: AppColors.sombras,
                                    fontSize: 11,
                                  ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            value,
            style: TextStyle(fontSize: 13, color: AppColors.sombras),
          ),
        ],
      ),
    );
  ...
  Widget _avatarFallback(String name) {
    return Container(
      ...
      height: 40,
      decoration: BoxDecoration(
        color: AppColors.azulSistemas.withValues(alpha: 0.15),
        borderRadius: BorderRadius.circular(8),
      ),
      child: Center(
        child: Text(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(
                        color: AppColors.sombras.withValues(alpha: 0.6),
                        fontSize: 13,
                      ),
                      filled: true,
