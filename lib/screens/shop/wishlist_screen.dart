  ...
  Widget build(BuildContext context) {
    ...
    var wishlistProducts = allProducts.where((p) {
      ...
      if (_searchQuery.isNotEmpty) {
        ...
        if (!matchesTitle && !matchesCategory && !matchesDesc && !matchesSpecs) {
          return false;
        }
      }
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Icon(Icons.search, color: AppColors.sombras),
                ...
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                  borderSide: BorderSide(color: AppColors.azulSistemas),
                ),
              ),
            ),
          ),
                ...
                Expanded(
                  child: Text(
                    _searchQuery.isNotEmpty
                        ...
                        : 'Mostrando ${wishlistProducts.length} artículos guardados',
