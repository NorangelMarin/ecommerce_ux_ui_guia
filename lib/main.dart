...
class MainApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Sincronizar colores globales para alto contraste y modo oscuro
    AppColors.isHighContrast = accessState.highContrast;
    AppColors.isNightMode = accessState.nightMode;
