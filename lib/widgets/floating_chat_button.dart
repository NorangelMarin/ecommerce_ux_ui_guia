      ...
      child: ScaleTransition(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: AppColors.of(context).naranjaUnimet.withValues(alpha: 0.45),
                blurRadius: 16,
                offset: Offset(0, 6),
              ),
            ],
      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text('elige_un_canal_de_contacto'.tr(),
          ...
          ListTile(
            ...
            title: Text('chat_va_whatsapp'.tr(),
              style: theme.textTheme.bodyMedium?.copyWith(
                fontWeight: FontWeight.w600,
                color: AppColors.of(context).textoPrincipal,
              ),
            ),
            subtitle: Text('respuesta_inmediata'.tr(),
              style: theme.textTheme.bodySmall?.copyWith(
                color: AppColors.of(context).sombras,
                fontSize: 11,
              ),
          ...
          ListTile(
            leading: Container(
              ...
              height: 40,
              decoration: BoxDecoration(
                color: AppColors.of(context).azulSistemas.withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(10),
              ),
              child: Icon(
                Icons.phone,
            ...
            title: Text('llamar'.tr(),
              style: theme.textTheme.bodyMedium?.copyWith(
                fontWeight: FontWeight.w600,
                color: AppColors.of(context).textoPrincipal,
              ),
            ),
            subtitle: Text('lunes_a_viernes_8am__5pm'.tr(),
              style: theme.textTheme.bodySmall?.copyWith(
                color: AppColors.of(context).sombras,
                fontSize: 11,
              ),
