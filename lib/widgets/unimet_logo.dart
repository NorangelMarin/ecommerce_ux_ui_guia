        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: AppColors.of(context).naranjaUnimet.withValues(alpha: 0.9),
          ...
          Positioned(
            ...
            child: Container(
              ...
              height: size * 0.55,
              decoration: BoxDecoration(
                color: AppColors.of(context).azulSistemas.withValues(alpha: 0.9),
          ...
          Positioned(
            ...
            child: Container(
              ...
              height: size * 0.45,
              decoration: BoxDecoration(
                color: AppColors.of(context).verdeSaman.withValues(alpha: 0.9),
